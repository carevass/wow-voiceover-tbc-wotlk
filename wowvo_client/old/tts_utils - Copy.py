...
class TTSProcessor(TTSEngine):
    ...
    def tts(self, text, voice_name, output_name, output_subfolder, forceGen=True, questgiver_id=None,
        ...
        #print(f"got {mapped_voice} for {voice_name}")
        ...
        if os.path.isfile(voice_path):
            pass
        elif os.path.isdir(voice_path):
            voice_path = os.path.join(VOICE_SAMPLE_FOLDER, f"{voice_name}")
        else:
            print(f"Voice sample(s) not found: {voice_path}")
            return
