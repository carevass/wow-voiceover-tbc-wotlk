...
local stutteringModels = {
    ...
    [124578]  = true, -- humscitizenmid
    [124670]  = true, -- keeper of the grove
    [125168]  = true, -- nether drakes
    [122893]  = true, -- ancient of lore
    [122895]  = true, -- ancient of war
    [122899]  = true, -- ancient protector
    [2123698] = true, -- dryads
    [124025] = true, -- frost nymphs
    [123680] = true, -- tauren druid bear
    [123766] = true, -- epic flight form ally
    [124841] = true, -- mammoth
    [125024] = true, -- murloc
    [125768] = true, -- saber worg
    [124155] = true, -- ghost
    [124952] = true, -- mountain giant
    [123040] = true, -- bear
    [124973] = true, -- stone giants (northrend)
    [124981] = true, -- iron giant (northrend)
    [126072] = true, -- stone keeper
    [123636] = true, -- drake
    [254847] = true, -- thorim
    [252758] = true, -- Freya
    [252761] = true, -- hodir
    [123610] = true, -- dragon whelp
    [126239] = true, -- troggs
    [126426] = true, -- water elemental
    [122877] = true, -- air elemental
...
local function GetTalkAnimationForModel(model)
    ...
    -- Specific NPC models do stuttering instead of talk animation
    -- fall back to stand (0) instead of trying to play talk (60).

    if fileID and stutteringModels[fileID] then
        return 0
    end
